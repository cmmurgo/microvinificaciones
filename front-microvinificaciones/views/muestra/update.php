...
$this->title = "Editar Muestra #" . $model->id;
$this->params["breadcrumbs"][] = ["label" => "Muestras", "url" => ["index"]];
$this->params["breadcrumbs"][] = ["label" => "Detalle #" . $model->id, "url" => ["view", "id" => $model->id]];
$this->params["breadcrumbs"][] = "Editar";
?>
<div class="muestra-update">
    ...
    <?= Html::submitButton("Actualizar Muestra", ["class" => "btn btn-primary w-100 btn-lg"]) ?>
    <?php ActiveForm::end(); ?>
</div>